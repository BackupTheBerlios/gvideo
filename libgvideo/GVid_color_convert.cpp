...
void 
GVConvert::yuyv2rgb (UINT8 *pyuv, UINT8 *prgb, int width, int height)
{
	int l=0;
...
void 
GVConvert::yuyv2bgr1 (UINT8 *pyuv, UINT8 *pbgr, int width, int height)
{
...
void 
GVConvert::yuyv2bgr (UINT8 *pyuv, UINT8 *pbgr, int width, int height)
{
...
*/
void GVConvert::yyuv_to_yuyv (UINT8 *framebuffer, UINT8 *tmpbuffer, int width, int height)
{
	UINT8 *ptmp=NULL;
	UINT8 *pfmb=NULL;
	ptmp = tmpbuffer;
...
*      height: picture height
*/
void GVConvert::uyvy_to_yuyv (UINT8 *framebuffer, UINT8 *tmpbuffer, int width, int height)
{
	UINT8 *ptmp = tmpbuffer;
	UINT8 *pfmb = framebuffer;
	int h=0;
	int w=0;
...
*      height: picture height
*/
void GVConvert::yvyu_to_yuyv (UINT8 *framebuffer, UINT8 *tmpbuffer, int width, int height)
{
	UINT8 *ptmp=NULL;
	UINT8 *pfmb=NULL;
	ptmp = tmpbuffer;
...
*      height: picture height
*/
void GVConvert::yuv420_to_yuyv (UINT8 *framebuffer, UINT8 *tmpbuffer, int width, int height) 
{
	UINT8 *py;
	UINT8 *pu;
	UINT8 *pv;
...
*      height: picture height
*/
void GVConvert::yvu420_to_yuyv (UINT8 *framebuffer, UINT8 *tmpbuffer, int width, int height) 
{
	UINT8 *py;
	UINT8 *pv;
	UINT8 *pu;
...
*      height: picture height
*/
void GVConvert::nv12_to_yuyv (UINT8 *framebuffer, UINT8 *tmpbuffer, int width, int height) 
{
	UINT8 *py;
	UINT8 *puv;
...
*      height: picture height
*/
void GVConvert::nv21_to_yuyv (UINT8 *framebuffer, UINT8 *tmpbuffer, int width, int height) 
{
	UINT8 *py;
	UINT8 *puv;
...
*      height: picture height
*/
void GVConvert::nv16_to_yuyv (UINT8 *framebuffer, UINT8 *tmpbuffer, int width, int height)
{
	UINT8 *py;
	UINT8 *puv;
...
*      height: picture height
*/
void GVConvert::nv61_to_yuyv (UINT8 *framebuffer, UINT8 *tmpbuffer, int width, int height)
{
	UINT8 *py;
	UINT8 *puv;
...
*      height: picture height
*/
void GVConvert::y41p_to_yuyv (UINT8 *framebuffer, UINT8 *tmpbuffer, int width, int height)
{
	int h=0;
	int w=0;
...
*      height: picture height
*/
void GVConvert::grey_to_yuyv (UINT8 *framebuffer, UINT8 *tmpbuffer, int width, int height)
{
	int h=0;
	int w=0;
	int offset = 0;
...
*      height: picture height
*/
void GVConvert::s501_to_yuyv(UINT8 *framebuffer, UINT8 *tmpbuffer, int width, int height)
{
	UINT8 *U, *V, *Y0, *Y1;
	UINT8 *line2;
	int h, w;
...
*      height: picture height
*/
void GVConvert::s505_to_yuyv(UINT8 *framebuffer, UINT8 *tmpbuffer, int width, int height)
{
	UINT8 *U, *V, *Y0, *Y1;
	UINT8 *line2;
	int h, w;
...
*      height: picture height
*/
void GVConvert::s508_to_yuyv(UINT8 *framebuffer, UINT8 *tmpbuffer, int width, int height)
{
	UINT8 *U, *V, *Y0, *Y1;
	UINT8 *line2;
	int h, w;
...
void GVConvert::convert_border_bayer_line_to_bgr24( UINT8* bayer, UINT8* adjacent_bayer,
...
void GVConvert::bayer_to_rgbbgr24(UINT8 *bayer,
	UINT8 *bgr, int width, int height,
...
*/
void 
GVConvert::bayer_to_rgb24(UINT8 *pBay, UINT8 *pRGB24, int width, int height, int pix_order)
{
	switch (pix_order) 
	{
...
void
GVConvert::rgb2yuyv(UINT8 *prgb, UINT8 *pyuv, int width, int height) 
{
...
void
GVConvert::bgr2yuyv(UINT8 *pbgr, UINT8 *pyuv, int width, int height) 
{
...
*      width: picture width
*/
void GVConvert::yuv420pto422(int * out,unsigned char *pic,int width)
{
	int j, k;
...
*      width: picture width
*/
void GVConvert::yuv422pto422(int * out,unsigned char *pic,int width)
{
	int j, k;
	unsigned char *pic0, *pic1;
	int *outy, *outu, *outv;
...
*      width: picture width
*/
void GVConvert::yuv444pto422(int * out,unsigned char *pic,int width)
{
	int j, k;
	unsigned char *pic0, *pic1;
	int *outy, *outu, *outv;
...
*      width: picture width
*/
void GVConvert::yuv400pto422(int * out,unsigned char *pic,int width)
{
	int j, k;
	unsigned char *pic0, *pic1;
	int *outy ;
